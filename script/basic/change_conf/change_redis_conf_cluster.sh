...
sed "s/^# cluster-config-file nodes-6379.conf/cluster-config-file nodes-$cport.conf/g" /root/docker_redis/result/redis5.conf >> /root/docker_redis/result/redis6.conf
